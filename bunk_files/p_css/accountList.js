...
/* ↓開発用URL */
const IDLIST_GAS_URL = 'https://script.google.com/macros/s/AKfycbxvWnLDCQPPjhTYf4ZsmkgI0rtzJ0ZBklczam35ECOtoa8smC0zYJVWjSmcyJyJ-GG8bw/exec';
/* ↑開発用URL */
var userDataList = [];
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p class="bal_typo_userContentsTtl">ID</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="bal_typo_userContentsTtl">たんじょうび</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="bal_typo_userContentsTtl">タイムスタンプ</p>
                                </td>
                                <td>
